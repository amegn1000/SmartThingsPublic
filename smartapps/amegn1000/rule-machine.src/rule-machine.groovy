...
definition(
	...
	iconX3Url: "https://s3.amazonaws.com/smartapp-icons/Partner/App-SmartBlock.png"
)
...
def mainPage() {
	if(!state.setup) firstRun()
    	...
    	dynamicPage(name: "mainPage", title: "Installed Rules, Triggers and Actions " + (nApps > 0 ? "[$nApps]" : ""), install: true, uninstall: false) {
        	section {
            	app(name: "childRules", appName: "Rule", namespace: "amegn1000", title: "Create New Rule...", multiple: true)
        	}
